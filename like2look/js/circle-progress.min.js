...
(function(b) {
    ...
    a.prototype = {
        ...
        initWidget: function() {
            if (!this.canvas) {
                this.canvas = b("<canvas>")[this.insertMode == "prepend" ? "prependTo" : "appendTo"](this.el)[0];
            }
            var d = this.canvas;
            d.width = this.size;
            d.height = this.size;
            ...
            if (window.devicePixelRatio > 1) {
                ...
                d.style.width = d.style.height = this.size + "px";
                d.width = d.height = this.size * c;
                this.ctx.scale(c, c);
            }
        },
        initFill: function() {
                ...
                if (c.length == 1) {
                    ...
                    if (c.length > 1) {
                        var k = l.gradientAngle || 0,
                            j = l.gradientDirection || [p / 2 * (1 - Math.cos(k)),
                                p / 2 * (1 + Math.sin(k)),
                                p / 2 * (1 + Math.cos(k)),
                                p / 2 * (1 - Math.sin(k))
                            ];
